...
user_avatar = "/Users/kdb/Desktop/ccc_highball/image/hol.png"
gpt_avatar = "/Users/kdb/Desktop/ccc_highball/image/baek.png"

def main():
    # 앱 타이틀 설정
    st.header("🥂인공지능 하이볼 머신")
    st.markdown("똥손들도 걱정없이 만드는 정량 하이볼")
    st.markdown("[More Projectl](https://maker.wiznet.io/louis_m/projects/ai%2Dpoe%2Dmy%2Dhighball/?serob=rd&serterm=month)")
    st.image("/Users/kdb/Desktop/ccc_highball/image/body.png", use_column_width=True)
    ...
    with st.form(key='message_form'):
        # 사용자 입력 받기
        user_input = st.text_input("메시지를 입력하세요", key="input", value=st.session_state['input_value'])
    ...
    if submit_button:
        ...
        # 챗봇의 응답 생성
        bot_response = generate_response(client, user_input, st.session_state['conversations'])
